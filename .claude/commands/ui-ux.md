...
Validate **inline** cạnh ô lỗi, nói _cách sửa_ (không chỉ "sai") · nút submit **disable + loading** khi gửi (chặn double-submit) · thất bại thì **giữ nguyên dữ liệu đã nhập** · hành động phá hủy ưu tiên **Undo** hơn hỏi "chắc chưa?" · thao tác > ~400ms phải có chỉ báo tiến trình.
...
Gọn, ưu tiên hành động: mỗi đề xuất kèm _vì sao_ (1 dòng) và _ràng buộc khung nào_ nó thỏa. Kết bằng **checklist** rút gọn để tự đối chiếu trước khi code:
