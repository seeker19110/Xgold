...
Đọc kỹ `docs/ops/audit-toi-uu-prompt.md` trong repo này và **làm theo đúng quy trình trong đó**.

Ràng buộc bắt buộc (chi tiết & lệnh đo cụ thể nằm ở file trên — bám đúng `BO-SUNG-chat-luong.md` Nhóm 2 mục 9 + `AP-DUNG-vao-du-an-co-san.md` Bước 2–3 + `CLAUDE.md` §3 mục 10):
...
Nếu **không tìm thấy** `docs/ops/audit-toi-uu-prompt.md` (repo chưa áp khung), vẫn tiến hành theo đúng ràng buộc tóm tắt trên và báo cho người dùng biết file chưa có để cân nhắc chạy `copy-framework.sh`.
