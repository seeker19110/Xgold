...
- Giai đoạn hiện tại: GĐ 4 (Phát triển) — MVP Đợt 0–4 đã xong (Multi-MA + Multi-RSI hoạt động, kiểm chứng thật bằng trình duyệt + 22 E2E xanh). Việc còn lại chỉ làm được ngoài sandbox (deploy Supabase thật) — xem `PROGRESS.md` mục "Tiếp theo"/"Nợ kỹ thuật".
